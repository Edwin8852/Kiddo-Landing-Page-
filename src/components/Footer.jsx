...
import { Mail, Phone, MapPin, Shield, Zap, Globe } from 'lucide-react';
...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0b0e14] pt-32 pb-12 relative overflow-hidden">
      <BrandModal 
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            >
              <div className="h-16 overflow-hidden bg-white/10 rounded-2xl p-2 group-hover:scale-105 transition-transform">
                <img 
                  src="/kiddo_logo.png" 
                  alt="Kiddo Logo" 
              ...
              <span className="text-white font-black text-3xl tracking-tighter">KIDDO</span>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-4">
              {footerLinks.legal.map(item => (
                <a key={item} href="#" className="text-white/30 hover:text-white text-[10px] font-black uppercase tracking-widest transition-colors">
                  {item}
                </a>
              ))}
            </div>
